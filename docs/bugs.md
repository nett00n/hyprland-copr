...
- **BUG-0009** Makefile `full-cycle` passes `FORCE_MOCK`/`DRY_RUN` env vars into the container but nothing in scripts/ reads them -> silent no-op flags, misleading #low
