...
- **BUG-0015** — cached-stage check trusts DB state alone, confirmed root cause of a bad publish
- **BUG-0018** — local mock can't catch chroot-specific Copr failures before submitting
- **BUG-0013** — two `-git` packages' auto-update has silently never applied for weeks
